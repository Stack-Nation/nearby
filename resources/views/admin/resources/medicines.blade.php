    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <div id="medicines" class="row mt-2">
                <form action="{{route("admin.resources.medicines.add")}}" enctype="multipart/form-data" method="post">
                    @csrf
                ...
                <div id="searchr" class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12"><a href="{{route("admin.resources.medicines.verify",$resource->id)}}" class="btn btn-warning mt-2">Verify</a></div>
                    </div>
                        <hr>
                    @endforeach
                @else
