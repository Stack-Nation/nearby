@extends('layouts.app')
@section("title","Vaccination Facilities")
@section('head')
<style>
    #map{
        height: 500px;
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <div id="vaccination" class="row mt-2">
                <form action="{{route("admin.resources.vaccination.add")}}" enctype="multipart/form-data" method="post">
                    @csrf
    ...
    function initMap() {
        ...
        @if($vaccinations->count()>0)
            ...
            marker = new google.maps.Marker({
                position: pos,
                map: map,
                icon: '{{asset("assets/icons/vaccine.png")}}'
            });
            infowindow = new google.maps.InfoWindow()
