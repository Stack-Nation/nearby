@extends('layouts.app')
@section("title","Covid-19 Testings")
@section('head')
<style>
    #map{
        height: 500px;
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-5">
            <div id="testing" class="row mt-2">
                <form action="{{route("admin.resources.testing.add")}}" enctype="multipart/form-data" method="post">
                    @csrf
                ...
                <div id="searchr" class="row">
                    ...
                    <div class="row">
                        ...
                        @endif
                        <div class="col-12"><a href="{{route("resources.edit.testing",$resource->id)}}" class="btn btn-success btn-block">Edit</a></div>
                        <div class="col-12"><a href="{{route("admin.resources.testing.verify",$resource->id)}}" class="btn btn-warning mt-2">Verify</a></div>
                    </div>
                        <hr>
                    @endforeach
                @else
    ...
    function initMap() {
        ...
        @if($testings->count()>0)
            ...
            marker = new google.maps.Marker({
                position: pos,
                map: map,
                icon: '{{asset("assets/icons/covid-test.png")}}'
            });
            infowindow = new google.maps.InfoWindow()
