    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <div id="hospital" class="row mt-2">
                <form action="{{route("admin.resources.hospital.add")}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <input type="file" id="file" name="file" onchange="this.form.submit()" hidden>
